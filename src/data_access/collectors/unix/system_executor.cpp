...
const Result<std::string> SystemExecutor::Execute(const std::string& command) noexcept {
    try {
        ...
        return Result<std::string>(ResultStatus::InternalError, "SystemExecutor exception: " + std::string(e.what()));
    }
}